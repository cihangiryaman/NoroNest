...
{
	public class UserAcquisitionRepository : Repository<UserAcquisition>, IUserAcquisitionRepository
	{
		public UserAcquisitionRepository(NoroNestDbContext context) : base(context)
		{
		}
	}
}
