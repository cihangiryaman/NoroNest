...
{
	public class GameService : BaseService<Game, GameDTO>
	{
		public GameService(IUnitOfWork unitOfWork, IMapper mapper, string keyPropertyName = "Id") : base(unitOfWork, mapper, keyPropertyName)
		{
		}
	}
}
